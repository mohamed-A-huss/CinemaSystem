...
namespace CinemaSystem.Areas.Identity.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController
            (UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmailSender emailSender, IRepository<ApplicationUserOTP> applicationUserOTPRepository)
        {
        ...
        public async Task<IActionResult> Login(LoginVM loginVM)
        {
            ...
            var result = await _signInManager.PasswordSignInAsync(
                user, loginVM.Password, loginVM.RememberMe, lockoutOnFailure: true);
            if (!result.Succeeded)
            {
                ModelState.AddModelError(string.Empty, "Invalid login attempt.");
        ...
        public async Task<IActionResult> ForgetPassword(ForgetPasswordVM forgetPasswordVM)
        {
            ...
            if (user is null)
            {
            TempData["error-notification"] = "Attempt failed";
                return View(forgetPasswordVM);
